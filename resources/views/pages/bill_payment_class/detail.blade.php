    ...
    <div class="">
        <div class="mb-5 page-title">
            <div class="title_left">
                <h3><small>Pembayaran Tagihan <small><b>{{'Kelas '.$bill->billClass->class->name}}</b></small></small></h3>
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <a
                            ...
                            href="{{ route('billPaymentClass.index') }}"
                        >
                    ...
                    <div class="x_content">
                        <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#lunas" role="tab" aria-controls="home" aria-selected="true">Lunas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="home-tab" data-toggle="tab" href="#belumlunas" role="tab" aria-controls="home" aria-selected="false">Cicil</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                            {{-- Sudah Lunas --}}
                            <div class="tab-pane fade active show" id="lunas" role="tabpanel" aria-labelledby="home-tab">
                                <div class="col-md-12 col-sm-12 ">
                                    <div class="x_panel">
                                        <div class="x_content">
                            ...
                            {{-- belum lunas --}}
                            <div class="tab-pane fade" id="belumlunas" role="tabpanel" aria-labelledby="home-tab">
                                <div class="col-md-12 col-sm-12 ">
                                    <div class="x_panel">
                                        <div class="x_content">
                                            <table class="table table-striped">
                                                        ...
                                                        @if ($student != NULL && $student->status != 'lunas')
                                                            <tr>
                                                                <th scope="row">
                                                                    {{$no2++}}
                                                                    <!-- Show modal -->
                                                                    <div class="modal fade showModal" id="showData2{{$data->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                                        <div class="modal-dialog modal-lg">
                                                                            <div class="modal-content">
