                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#sudahBayar" role="tab" aria-controls="home" aria-selected="true">Sudah Lunas</a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    @foreach ($lunas as $index => $data)
                                                        @php
                                                            foreach ($data->student->sppPayment as $key => $amount[$data->student_id]) {
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="row">
                                                                                        <table class="table table-bordered">
                                                                                            ...
                                                                                            <tr>
                                                                                                <th>Bukti</th>
                                                                                                <td><a href="{{asset('bukti/spp/'. $data->proof)}}" target="blank"><i class="fa fa-eye"></i>&nbsp;Lihat</a></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </div>
                                                                                </div>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($cicil as $data)
                                                        @php
                                                            $student = App\Models\SppPayment::where('student_id', $data->student_id)->orderBy('id', 'desc')->first();
                                                        @endphp
