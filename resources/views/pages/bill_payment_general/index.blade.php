    ...
    <div class="">
        <div class="mb-5 page-title">
            <div class="title_left">
                <h3><small>Pembayaran Tagihan Umum</small></h3>
            </div>
        </div>
                                        ...
                                        <tbody>
                                            @foreach ($bills as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-success btn-sm" href="{{ route('billPaymentGeneral.show', $data->id) }}">Detail</a>
                                                    ...
                                                    <div class="modal fade showModal" id="pay{{$data->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <form action="{{route('billPaymentGeneral.update', $data->id)}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PUT')
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input id="besaran" type="number" class="form-control" name="amount" placeholder="Max: {{$data->sum}}">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-6">
                                                                                    <div class="form-group">
