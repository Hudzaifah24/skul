...
class StudentExport implements FromCollection, WithMapping, WithHeadings, WithStyles, WithColumnWidths, WithEvents
{
    /**
    ...
    */
    ...
    {
        return StudentClass::with(['student', 'clas'])->get();
    }
